...
RUN apt-get update -y && \
    apt-get -y install openvas libxdamage1 libgtk-3-0 libasound2 libnss3 libxss1 sudo bzip2 wget expect libxdamage1 libgtk-3-0 libasound2 libnss3 libxss1 libx11-xcb1
...
RUN sh -c '/bin/echo -e "\nyes\nubuntu\ntest@test.com\ntest123!\ntest123!\n"| /tmp/acunetix_13.0.200715107_x64.sh'
...
CMD su -l acunetix -c /home/acunetix/.acunetix/start.sh;openvas-setup
